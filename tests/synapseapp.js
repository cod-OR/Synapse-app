...
import FormView from './viewObjects/view';


const targetPlatforms = [TestConfig.iosBaseCapabilities()];
targetPlatforms.forEach(function(platform) {
        ...
        describe(`Stock Price ${platform.capabilities.platformName} App Test`, function() {
            ...
            it('Enter text', async function() {
                const StockPriceView = new FormView(driver);
